package com.lisa.fullcrudsavetravels.controllers;
...
import com.lisa.fullcrudsavetravels.services.ExpenseService;
...
public class ExpenseController {
    ...
    public String update(
    		@Valid @ModelAttribute("editExpense") Expense expense, BindingResult result) {
        if (result.hasErrors()) {
            return "edit.jsp";
        } else {

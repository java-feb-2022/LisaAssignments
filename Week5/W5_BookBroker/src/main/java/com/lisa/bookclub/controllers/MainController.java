...
public class MainController {
	...
	public String editBook(@PathVariable("id") Long id, @Valid @ModelAttribute("editBook") Book editBook, BindingResult result, Model model, HttpSession session) {
...
//	    editBook.setBorrower(borrower);
//	    editBook.setModifier(modifier);
